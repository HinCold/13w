        ...
        if len(ct[key]):
            ...
            if key == 'straight':
                ...
                if not bottom == None:
                    ...
                    sc += getrankpoint(brank)*0.1
                    if key == 'triplets':
                        sc += getrankpoint(bottom[0].rank)*0.1
                    qbsc.append(sc)
                    if len(bottom) < 5:
                        if len(ct['single']) < 5 - len(bottom):
                            continue
        ...
        for m in range(len(qmd)):
            ...
            for key in ct:
                ...
                if key == 'cp':
                    ...
                    break
                elif key == 'resamesuitstraight' or key == 'restraight' or key == 'samesuitstraight' or key =='straight':
                    continue
                elif len(ct[key]):
                    sc = getctpoint(key)
                    #sc += getrankpoint(hrank) * 0.1
